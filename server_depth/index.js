            ...
            bids.forEach(bid => {
                ...
                for (const [rangeKey, rangeValue] of Object.entries(ranges)) {
                    if (price >= rangeValue) {
                        ...
                        kucoin_data[rangeKey]=totalValues[rangeKey]
        ...
        if (orderbookResponse.ok && tickerResponse.ok) {
            ...
            bids.forEach(bid => {
                ...
                for (const [rangeKey, rangeValue] of Object.entries(ranges)) {
                    if (price >= rangeValue) {
                        totalValues[rangeKey] += value;
                       mexc_data[rangeKey]=totalValues[rangeKey]
        ...
        if (orderbookResponse.ok && tickerResponse.ok) {
            ...
            bids.forEach(bid => {
                ...
                for (const [rangeKey, rangeValue] of Object.entries(ranges)) {
                    if (price >= rangeValue) {
                        totalValues[rangeKey] += value;
                       htx_data[rangeKey]=totalValues[rangeKey]
        ...
        if (orderbookResponse.ok && tickerResponse.ok) {
            ...
            bids.forEach(bid => {
                ...
                for (const [rangeKey, rangeValue] of Object.entries(ranges)) {
                    if (price >= rangeValue) {
                        totalValues[rangeKey] += value;
                       asd_data[rangeKey]=totalValues[rangeKey]
